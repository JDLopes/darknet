...
crop_layer make_crop_layer(int batch, int h, int w, int c, int crop_height, int crop_width, int flip, Unum4 angle, Unum4 saturation, Unum4 exposure)
{
