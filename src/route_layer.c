...
void resize_route_layer(route_layer *l, network *net)
{
    ...
    l->inputs = l->outputs;
    l->delta =  realloc(l->delta, l->outputs*l->batch*sizeof(Unum4));
    l->output = realloc(l->output, l->outputs*l->batch*sizeof(Unum4));
...
void forward_route_layer(const route_layer l, network net)
{
    ...
    for(i = 0; i < l.n; ++i){
        int index = l.input_layers[i];
        Unum4 *input = net.layers[index].output;
...
void backward_route_layer(const route_layer l, network net)
{
    ...
    for(i = 0; i < l.n; ++i){
        int index = l.input_layers[i];
        Unum4 *delta = net.layers[index].delta;
        int input_size = l.input_sizes[i];
        for(j = 0; j < l.batch; ++j){
...
void forward_route_layer_gpu(const route_layer l, network net)
{
    ...
    for(i = 0; i < l.n; ++i){
        int index = l.input_layers[i];
        Unum4 *input = net.layers[index].output_gpu;
        int input_size = l.input_sizes[i];
        for(j = 0; j < l.batch; ++j){
...
void backward_route_layer_gpu(const route_layer l, network net)
{
    ...
    for(i = 0; i < l.n; ++i){
        int index = l.input_layers[i];
        Unum4 *delta = net.layers[index].delta_gpu;
        int input_size = l.input_sizes[i];
        for(j = 0; j < l.batch; ++j){
