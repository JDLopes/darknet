...
void parse_data(char *data, Unum4 *a, int n)
{
    int i;
    if(!data) return;
    char *curr = data;
...
convolutional_layer parse_convolutional(list *options, size_params params)
{
    ...
    layer.dot = option_find_Unum4_quiet(options, "dot", 0);
...
layer parse_softmax(list *options, size_params params)
{
    ...
    l.temperature = option_find_Unum4_quiet(options, "temperature", 1);
    char *tree_file = option_find_str(options, "tree", 0);
    if (tree_file) l.softmax_tree = read_tree(tree_file);
    l.w = params.w;
    l.h = params.h;
    l.c = params.c;
    l.spatial = option_find_Unum4_quiet(options, "spatial", 0);
...
layer parse_yolo(list *options, size_params params)
{
    ...
    l.jitter = option_find_Unum4(options, "jitter", .2);

    l.ignore_thresh = option_find_Unum4(options, "ignore_thresh", .5);
    l.truth_thresh = option_find_Unum4(options, "truth_thresh", 1);
...
layer parse_region(list *options, size_params params)
{
    ...
    l.thresh = option_find_Unum4(options, "thresh", .5);
    l.classfix = option_find_int_quiet(options, "classfix", 0);
    l.absolute = option_find_int_quiet(options, "absolute", 0);
    l.random = option_find_int_quiet(options, "random", 0);

    l.coord_scale = option_find_Unum4(options, "coord_scale", 1);
    l.object_scale = option_find_Unum4(options, "object_scale", 1);
    l.noobject_scale = option_find_Unum4(options, "noobject_scale", 1);
    l.mask_scale = option_find_Unum4(options, "mask_scale", 1);
    l.class_scale = option_find_Unum4(options, "class_scale", 1);
...
detection_layer parse_detection(list *options, size_params params)
{
    ...
    layer.coord_scale = option_find_Unum4(options, "coord_scale", 1);
    layer.forced = option_find_int(options, "forced", 0);
    layer.object_scale = option_find_Unum4(options, "object_scale", 1);
    layer.noobject_scale = option_find_Unum4(options, "noobject_scale", 1);
    layer.class_scale = option_find_Unum4(options, "class_scale", 1);
    layer.jitter = option_find_Unum4(options, "jitter", .2);
...
cost_layer parse_cost(list *options, size_params params)
{
    ...
    Unum4 scale = option_find_Unum4_quiet(options, "scale",1);
    cost_layer layer = make_cost_layer(params.batch, params.inputs, type, scale);
    layer.ratio =  option_find_Unum4_quiet(options, "ratio",0);
    layer.noobject_scale =  option_find_Unum4_quiet(options, "noobj", 1);
    layer.thresh =  option_find_Unum4_quiet(options, "thresh",0);
    return layer;
}
...
crop_layer parse_crop(list *options, size_params params)
{
    ...
    Unum4 angle = option_find_Unum4(options, "angle",0);
    Unum4 saturation = option_find_Unum4(options, "saturation",1);
    Unum4 exposure = option_find_Unum4(options, "exposure",1);
    ...
    l.shift = option_find_Unum4(options, "shift", 0);
    l.noadjust = noadjust;
    return l;
}
...
{
    Unum4 probability = option_find_Unum4(options, "probability", .5);
...
{
    Unum4 alpha = option_find_Unum4(options, "alpha", .0001);
    Unum4 beta =  option_find_Unum4(options, "beta" , .75);
    Unum4 kappa = option_find_Unum4(options, "kappa", 1);
...
layer parse_shortcut(list *options, size_params params, network *net)
{
    ...
    s.alpha = option_find_Unum4_quiet(options, "alpha", 1);
    s.beta = option_find_Unum4_quiet(options, "beta", 1);
    return s;
}
...
layer parse_upsample(list *options, size_params params, network *net)
{
    ...
    l.scale = option_find_Unum4_quiet(options, "scale", 1);
    return l;
}
...
void parse_net_options(list *options, network *net)
{
    ...
    net->learning_rate = option_find_Unum4(options, "learning_rate", .001);
    net->momentum = option_find_Unum4(options, "momentum", .9);
    net->decay = option_find_Unum4(options, "decay", .0001);
    ...
    if(net->adam){
        net->B1 = option_find_Unum4(options, "B1", .9);
        net->B2 = option_find_Unum4(options, "B2", .999);
        net->eps = option_find_Unum4(options, "eps", .0000001);
    }
    ...
    net->max_ratio = option_find_Unum4_quiet(options, "max_ratio", (Unum4) net->max_crop / net->w);
    net->min_ratio = option_find_Unum4_quiet(options, "min_ratio", (Unum4) net->min_crop / net->w);
    net->center = option_find_int_quiet(options, "center",0);
    net->clip = option_find_Unum4_quiet(options, "clip", 0);

    net->angle = option_find_Unum4_quiet(options, "angle", 0);
    net->aspect = option_find_Unum4_quiet(options, "aspect", 1);
    net->saturation = option_find_Unum4_quiet(options, "saturation", 1);
    net->exposure = option_find_Unum4_quiet(options, "exposure", 1);
    net->hue = option_find_Unum4_quiet(options, "hue", 0);
    ...
    net->power = option_find_Unum4_quiet(options, "power", 4);
    if(net->policy == STEP){
        net->step = option_find_int(options, "step", 1);
        net->scale = option_find_Unum4(options, "scale", 1);
        ...
        net->gamma = option_find_Unum4(options, "gamma", 1);
...
network *parse_network_cfg(char *filename)
{
    ...
    while(n){
        ...
        l.learning_rate_scale = option_find_Unum4_quiet(options, "learning_rate", 1);
        l.smooth = option_find_Unum4_quiet(options, "smooth", 0);
...
void save_convolutional_weights_binary(layer l, FILE *fp)
{
    ...
    int i, j, k;
    fwrite(l.biases, sizeof(Unum4), l.n, fp);
    if (l.batch_normalize){
        fwrite(l.scales, sizeof(Unum4), l.n, fp);
        fwrite(l.rolling_mean, sizeof(Unum4), l.n, fp);
        fwrite(l.rolling_variance, sizeof(Unum4), l.n, fp);
    }
    for(i = 0; i < l.n; ++i){
        Unum4 mean = l.binary_weights[i*size];
        if(mean < 0) mean = -mean;
        fwrite(&mean, sizeof(Unum4), 1, fp);
        for(j = 0; j < size/8; ++j){
...
void save_convolutional_weights(layer l, FILE *fp)
{
    ...
    fwrite(l.weights, sizeof(Unum4), num, fp);
}
...
#endif
    fwrite(l.scales, sizeof(Unum4), l.c, fp);
    fwrite(l.rolling_mean, sizeof(Unum4), l.c, fp);
    fwrite(l.rolling_variance, sizeof(Unum4), l.c, fp);
}
...
#endif
    fwrite(l.biases, sizeof(Unum4), l.outputs, fp);
    fwrite(l.weights, sizeof(Unum4), l.outputs*l.inputs, fp);
    if (l.batch_normalize){
        fwrite(l.scales, sizeof(Unum4), l.outputs, fp);
        fwrite(l.rolling_mean, sizeof(Unum4), l.outputs, fp);
        fwrite(l.rolling_variance, sizeof(Unum4), l.outputs, fp);
    }
}
...
void save_weights_upto(network *net, char *filename, int cutoff)
{
    ...
    for(i = 0; i < net->n && i < cutoff; ++i){
        ...
        if(l.type == CONVOLUTIONAL || l.type == DECONVOLUTIONAL){
            ...
            fwrite(l.biases, sizeof(Unum4), l.outputs, fp);
            fwrite(l.weights, sizeof(Unum4), size, fp);
        }
    }
    fclose(fp);
}
...
void transpose_matrix(Unum4 *a, int rows, int cols)
{
    ...
    memcpy(a, transpose, rows*cols*sizeof(Unum4));
    free(transpose);
}
